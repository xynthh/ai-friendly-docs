...
- [Hybrid rendering](sections/hybrid-rendering.md)
  - [What is hybrid rendering?](sections/hybrid-rendering.md#what-is-hybrid-rendering)
  - [Setting up hybrid rendering](sections/hybrid-rendering.md#setting-up-hybrid-rendering)
  - [Server routing](sections/hybrid-rendering.md#server-routing)
  - [Accessing Request and Response via DI](sections/hybrid-rendering.md#accessing-request-and-response-via-di)
  - [Configuring a non-Node.js Server](sections/hybrid-rendering.md#configuring-a-non-nodejs-server)
  - [Configuring a Node.js Server](sections/hybrid-rendering.md#configuring-a-nodejs-server)
...
- [Guide Pipes](sections/guide-pipes.md)
  - [Change detection with pipes](sections/guide-pipes.md#change-detection-with-pipes)
  - [Understanding Pipes](sections/guide-pipes.md#understanding-pipes)
  - [Pipe precedence in template expressions](sections/guide-pipes.md#pipe-precedence-in-template-expressions)
  - [Using a pipe in a template](sections/guide-pipes.md#using-a-pipe-in-a-template)
  - [Custom pipes for new transforms](sections/guide-pipes.md#custom-pipes-for-new-transforms)
  - [Unwrapping data from an observable](sections/guide-pipes.md#unwrapping-data-from-an-observable)
- [Prerendering (SSG)](sections/prerendering.md)
  - [How to prerender a page](sections/prerendering.md#how-to-prerender-a-page)
- [Guide Routing](sections/guide-routing.md)
  - [Common Routing Tasks](sections/guide-routing.md#common-routing-tasks)
...
- [Server-side rendering](sections/ssr.md)
  - [Why use SSR?](sections/ssr.md#why-use-ssr)
  - [Enable server-side rendering](sections/ssr.md#enable-server-side-rendering)
  - [Configure server-side rendering](sections/ssr.md#configure-server-side-rendering)
  - [Hydration](sections/ssr.md#hydration)
  ...
  - [Using Angular Service Worker](sections/ssr.md#using-angular-service-worker)
